export const translations = {
  fr: {
    ...
    home: {
      ...
      presentation: "Développeur junior passionné par le code et l'innovation technologique. Pendant mon alternance, j'ai exercé en tant que consultant IT, où j'ai eu l'opportunité de travailler sur des projets sensibles en Java",
  ...
  en: {
    ...
    home: {
      ...
      presentation: "Junior developer passionate about code and technological innovation. During my work-study, I worked as an IT consultant, where I had the opportunity to work on robust and rewarding Java projects.",
