export const translations = {
  fr: {
    ...
    home: {
      ...
      presentation: "Développeur junior passionné par les nouvelles technologies. En alternance, j'ai travaillé comme consultant IT où j'ai eu l'opportunité de travailler sur des projets sensibles en Java.",
  ...
  en: {
    ...
    home: {
      ...
      presentation: "Junior developer passionate about new technologies. During my work-study, I worked as an IT consultant where I had the opportunity to work on sensitive Java projects.",
